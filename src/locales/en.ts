export default {
  ...
  leave: {
    ...
    table: {
      ...
      days: 'Days',
      status: 'Status',
      createAt: 'Submitted At',
      actions: 'Actions',
    },
    actions: { detail: 'Detail', submit: 'Apply for Leave', withdraw: 'Withdraw' },
    status: {
      pending: 'Pending',
      approved: 'Approved',
      rejected: 'Rejected',
    ...
    balance: {
      ...
      noBatches: 'No active annual-leave grants',
    ...
    detail: { title: 'Leave Detail', close: 'Close', approvalComment: 'Approval Comment' },
    withdraw: {
    ...
    tasks: { title: 'Approval Tasks', refresh: 'Refresh', review: 'Review' },
    review: {
    ...
    validation: {
      ...
      daysRequired: 'Please enter a positive number of days',
      daysHalfUnit: 'Days must be a multiple of 0.5',
    },
    error: {
      loadFailed: 'Failed to load leave data',
      saveFailed: 'Failed to submit',
      withdrawFailed: 'Failed to withdraw',
      reviewFailed: 'Failed to review',
    },
  },
}
