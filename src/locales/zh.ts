export default {
  ...
  leave: {
    ...
    actions: { detail: '详情', submit: '申请请假', withdraw: '撤回' },
    status: {
      pending: '待审批',
      approved: '已通过',
      rejected: '已驳回',
    ...
    detail: { title: '请假详情', close: '关闭', approvalComment: '审批意见' },
    withdraw: {
      title: '确认撤回',
      message: '确定要撤回该请假申请吗？',
      confirm: '撤回',
    ...
    tasks: { title: '审批任务', refresh: '刷新', review: '审批' },
    review: {
      title: '审批请假申请',
      comment: '审批意见',
      approve: '通过',
    ...
    validation: {
      ...
      daysRequired: '请输入正确的天数',
      daysHalfUnit: '天数必须是 0.5 的倍数',
    },
    error: {
      loadFailed: '加载请假数据失败',
      saveFailed: '提交失败',
