  ...
  common: {
    enums: {
      ...
      'role-code': {
        ...
        'view-department': '部门查看',
        'create-department': '部门创建',
        'update-department': '部门更新',
        'delete-department': '部门删除',
        'list-position': '职位列表',
        'view-position': '职位查看',
        'create-position': '职位创建',
        'update-position': '职位更新',
        'delete-position': '职位删除',
        'list-resource': '资源列表',
        'view-resource': '资源查看',
        'update-resource': '资源更新',
        'list-log': '日志列表',
        'view-log': '日志查看',
        'export-log': '日志导出',
        'upload-file': '文件上传',
