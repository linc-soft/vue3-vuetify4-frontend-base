export default {
  ...
  leave: {
    apply: {
      ...
      attachments: '附件',
      required: '此字段为必填',
      invalidDuration: '时长必须是0.5的倍数',
      submit: '提交',
      reset: '重置',
      cancel: '取消',
      confirmTitle: '确认请假申请',
      confirmMessage: '确定要提交此请假申请吗？',
      confirm: '确认',
      success: '请假申请提交成功',
      failed: '请假申请提交失败',
    },
