export default {
  ...
  common: {
    enums: {
      ...
      'role-code': {
        ...
        'update-user': 'ユーザー更新',
        'delete-user': 'ユーザー削除',
        'export-user': 'ユーザーエクスポート',
        'list-department': '部門一覧',
        'view-department': '部門詳細',
        'create-department': '部門作成',
        'update-department': '部門更新',
        'delete-department': '部門削除',
        'list-position': '職位一覧',
        'view-position': '職位詳細',
        'create-position': '職位作成',
        'update-position': '職位更新',
        'delete-position': '職位削除',
        'list-resource': 'リソース一覧',
        'view-resource': 'リソース詳細',
  ...
  profile: {
    ...
    confirmTitle: '保存の確認',
    confirmMessage: 'プロフィールの変更を保存してもよろしいですか？',
    confirmYes: '確認',
  },
  iconSelect: {
    search: 'アイコンを検索',
